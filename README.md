...
A user-friendly desktop app that combines two powerful tools into one: a **Takeout Photos Fixer** for batch-processing Takeout folders, and a **Single File Editor** for manually correcting individual media files.  
...
### Takeout Photos Fixer (Batch Tool)

Restore correct dates, times, GPS tags, and descriptions to your Takeout Photo exports by reading their Takeout JSON sidecars.
...
* **Full Metadata:** Writes GPS coordinates and descriptions to embedded metadata.  
* **File Organization:**  
...
4. **Select a Tool:** Use the navigation bar at the top to choose either **Bulk Metadata Fixer** or **Single File Editor**.

### **If using the Takeout Photos Fixer:**

1. **Select Folder:** Click **Browse** and choose your main Takeout folder (e.g., Takeout/Google Photos).  
